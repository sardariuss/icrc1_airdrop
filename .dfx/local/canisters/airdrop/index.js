...
export const canisterId = process.env.AIRDROP_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./airdrop.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the airdrop canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./airdrop.did.js")._SERVICE>}
 */
